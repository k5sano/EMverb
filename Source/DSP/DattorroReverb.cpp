...
void DattorroReverb::init() { clear(); // Clouds default LFO frequencies (per sample, at 32kHz) lfo\_\[0\].setFrequency(0.5f / 32000.0f); lfo\_\[1\].setFrequency(0.3f / 32000.0f); lp\_ = 0.7f; diffusion\_ = 0.625f; lpDecay1\_ = 0.0f; lpDecay2\_ = 0.0f; }

void DattorroReverb::clear() { std::memset(buffer\_, 0, sizeof(buffer\_)); writePtr\_ = 0; lpDecay1\_ = 0.0f; lpDecay2\_ = 0.0f; }

void DattorroReverb::setModSpeed(float speed) { // speed 0..1 → scale the base LFO frequencies float scale = 0.2f + speed \* 1.6f; // range 0.2x .. 1.8x lfo\_\[0\].setFrequency(0.5f / 32000.0f \* scale); lfo\_\[1\].setFrequency(0.3f / 32000.0f \* scale); }
