...
/// Adapts between host sample rate and 32kHz internal rate. /// Based on CLOUDSVST SampleRateAdapter with Hermite interpolation. class SampleRateAdapter { public: SampleRateAdapter() = default; ~SampleRateAdapter() = default;
